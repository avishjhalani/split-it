...
export const getAllContacts = query({
    handler:async(ctx)=>{
        ...
        .query("expenses")
        .withIndex("by_user_and_group", (q) => q.eq("paidByUserId", currentUser._id).eq("groupId",undefined)).collect();

        const expensesNotPaidedByYou = (await ctx.db
        .query("expenses")
        ...
        const personalExpenses = [...expensesYouPaid,...expensesNotPaidedByYou];
